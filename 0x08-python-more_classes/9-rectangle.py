...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Static method for comparing rectangles
        ...
        Returns:
            Rectangle: The biggest rectangle, rect_1 if both
                are equal.
    ...
    def square(cls, size=0):
        """Method that returns new Rectangle instance

        Args:
            size (int, optional): The length of each side
                of the new Rectangle. Defaults to 0.

        Returns:
            Rectangle: A square based on Rectangle.
